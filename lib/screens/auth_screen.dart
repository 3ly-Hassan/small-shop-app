...
//          MaterialPageRoute(builder: (context) => ProductsOverviewScreen()));
      ...
      if (error.toString().contains('EMAIL_EXISTS'))
        errorMassage = 'emali is already in use';
      else if (error.toString().contains('INVALID_EMAIL'))
        errorMassage = 'emali is invalid';
      else if (error.toString().contains('WEAK_PASSWORD'))
        errorMassage = 'choose a strong password';
      else if (error.toString().contains('EMAIL_NOT_FOUND'))
        errorMassage = 'email not found';
      else if (error.toString().contains('INVALID_PASSWORD'))
        errorMassage = 'the password is wrong';
      showErrorDialog(errorMassage);
    } catch (error) {
      var errorMassage = 'error.., try again later';
      showErrorDialog(errorMassage);
    }
